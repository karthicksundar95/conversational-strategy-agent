...
from modules.tools import load_prompt, extract_python_code_block
import re
...
async def generate_plan(
    ...
    try:
        ...
        # Extract Python code from markdown code blocks (handles text before/after)
        raw = extract_python_code_block(raw)
